...
| 🐳 Fase 2 — IaC & Container Security | 🔄 Berjalan | 14/15 |
...
- [ ] **Hari 15** — Pipeline CI/CD dengan Secret Scan + SAST + SCA berjalan otomatis
- [ ] **Hari 30** — Docker hardened + IaC Terraform + DAST live di pipeline
