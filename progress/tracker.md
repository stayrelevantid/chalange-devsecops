...
| [Hari 08](daily/hari-08.md) | SAST Setup (Semgrep) | Semgrep lokal menemukan insecure crypto & SQL injection | ⬜ | — |
...
| Hari | Topik | Output Konkret | Status | Selesai |
|------|-------|----------------|--------|---------|
| [Hari 31](daily/hari-31.md) | K8s Cluster + Deploy | k3d cluster + `kubectl apply` deployment & service | ⬜ | — |
...
| [Hari 36](daily/hari-36.md) | OPA Policy Testing | Deploy Pod tanpa limits → "Denied by Gatekeeper" | ⬜ | — |
...
| [Hari 41](daily/hari-41.md) | Falco Attack Simulation | `kubectl exec` → cek Falco log Notice/Warning | ⬜ | — |
...
| Hari | Topik | Output Konkret | Status | Selesai |
|------|-------|----------------|--------|---------|
| [Hari 46](daily/hari-46.md) | DefectDojo Setup | Docker Compose up, login dashboard | ⬜ | — |
...
| Metrik | Nilai |
|--------|-------|
| Total Hari Selesai | 6 / 60 |
| Fase Selesai | 0 / 4 |
| Hari Aktif (ada catatan) | 6 |
